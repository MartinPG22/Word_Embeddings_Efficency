...
glove_path = 'GloVe/glove.6B/glove.6B.50d.txt'  # Ruta al archivo GloVe
embedding_dim = 50
...
df_train.to_csv('Datos/texto_train_with_embeddings-GloVe-50.csv', index=False)
df_test.to_csv('Datos/texto_test_with_embeddings-GloVe-50.csv', index=False)

print("Embeddings guardados en 'texto_train_with_embeddings-GloVe-50.csv' y 'texto_test_with_embeddings-GloVe-50.csv'.")
